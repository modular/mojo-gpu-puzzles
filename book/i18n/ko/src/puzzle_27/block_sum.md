...
[sum](https://max.modular.com/mojo/std/gpu/primitives/block/sum) 연산으로
...
**핵심 통찰:**
_[block.sum()](https://max.modular.com/mojo/std/gpu/primitives/block/sum)
...
### 4. **[block.sum()](https://max.modular.com/mojo/std/gpu/primitives/block/sum) API 개념**
