...
1D TileTensor `a`와 1D TileTensor `b`의 내적을 계산하여 1D TileTensor `output`(단일 값)에 저장하는 커널을 구현하세요.
...
- [Puzzle 8](../puzzle_08/layout_tensor.md), [Puzzle 11](../puzzle_11/layout_tensor.md)에서 이어지는 TileTensor 기반 병렬 리덕션
