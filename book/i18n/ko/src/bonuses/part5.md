...
[Puzzle 33](../puzzle_33/puzzle_33.md)을 완료하고 Mojo의 `TensorCore` API를 사용하여 실제 텐서 코어 행렬 곱셈을 구현했습니다. 구현은 정확하게 동작하고, 모든 정확도 테스트를 통과하며, 실제 하드웨어 가속 행렬 연산을 사용합니다. 그런데 [Puzzle 16](../puzzle_16/tiled.md)의 타일링 버전과 프로파일링으로 비교하면...
