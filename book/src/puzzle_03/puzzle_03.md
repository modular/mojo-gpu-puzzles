...
These boundary handling patterns will become more elegant when we [learn about TileTensor in Puzzle 4](../puzzle_04/introduction_layout_tensor.md), which provides built-in shape management.
